        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    InsertedUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Views = table.Column<long>(type: "bigint", nullable: false),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MediaFiles_Users_InsertedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediaGenreMovie", x => new { x.GenresId, x.MoviesId });
                    table.ForeignKey(
                        name: "FK_MediaGenreMovie_MediaGenres_GenresId",
                        column: x => x.GenresId,
                        principalTable: "MediaGenres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MediaGenreMovie_Movies_MoviesId",
                        column: x => x.MoviesId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaFiles_InsertedUserId",
                table: "MediaFiles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaGenreMovie_MoviesId",
                table: "MediaGenreMovie",
                column: "MoviesId");
